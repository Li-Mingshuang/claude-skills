...
Li-Mingshuang 发布的 Claude Code skill 合集。

🌐 **展示页**：https://li-mingshuang.github.io/claude-skills/

## 已发布

| Skill | 描述 | 课程页 |
|---|---|---|
| [context-injector](https://github.com/Li-Mingshuang/claude-context-injector) | 自动注入时间/天气/Git 状态到每条对话 | [→ 查看](https://li-mingshuang.github.io/claude-context-injector/course.html) |
